...
Ideal Case Scenario: Hook students up to a VR headset in class and attend it in the VR World.
Not a replacement of classes, rather a replacement of the classic chalkboard and notebook teaching.
...
- Letting children grasp abstract and practical concepts more easily.
  + By visualizing said concepts in a VR Class.

** Negatives
- The technology may cause children to overuse it
- More screen time
- Issues associated with long hours of using vr
-price issue for unprivileged
...
*** Social sciences
+ Civilizations, eg. Mohenjadaro, Harappa, Arikamedu
+ Historical Events 
+ great wars in history
+ Museums
+wind directions, wave or tide flow directions that are usually difficult to comprehend

*** Abstract Concepts
+ Mathematical calculations
  - Arithmetic
  - Volume and Surface Area
+ Music Theory (can't elaborate, I only play the guitar for fun)
...
+ Graphics in Blender (Requires 3D designing abilities) - 3 hours to learn minimum
  - Could also just build a 2D concept sketch version if there's less time?
